...
from . import acquire, crosswalk as crosswalk_mod, distill, manifest, redesign as redesign_mod, refactor as refactor_mod, render, storage
...
def create_app(root: Optional[str | Path] = None, transport=None, api_key: Optional[str] = None) -> FastAPI:
    ...
    def _overview(pid: str) -> dict:
        ...
        tabs = {
            "corpus": bool(man),
            "derived": n_ext > 0,
            "refactor": (g / "registers" / "operations.json").exists(),
